...
private:
	...
	//////////////////////////////////////////////////////////////////////////////////////
	// Modification 1: Adding header function for function that calculate the chi distance
...
// Modification 2: adding chi kernel equation//////////////////////////////
 ...
 gamma(param.gamma), coef0(param.coef0)
{
	switch(kernel_type)
	{
		...
		case SIGMOID:
			...
			break;
			//Modification 3: adding option for Chi //////////////////////////////////////////////////////
		case CHISQUARED:
...
////// Modification 4: Adding the function that calculate chi equation///////////////
...
// Modification 5: Adding Option for the kernel parameter/////////////////////////
		case CHISQUARED:
...
// Modification 6: Adding Chi as new type in kernel table//////////////////////////////
static const char *kernel_type_table[]=
{
	"linear","polynomial","rbf","sigmoid","precomputed","chisquared",NULL
};
...
const char *svm_check_parameter(const svm_problem *prob, const svm_parameter *param)
{
	...
	if(kernel_type != LINEAR &&
	   ...
	   ////////////// Modification 7:  checking Kernel Type for Chi
